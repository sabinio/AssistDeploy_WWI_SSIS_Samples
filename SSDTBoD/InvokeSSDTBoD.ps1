...
Function Invoke-SSDTBoD {
    ...
    Invoke-MsBuildSSDT -DatabaseSolutionFilePath $WWI_DW_SLN -DataToolsFilePath $WWI_DW_DAC 
        ...
        Write-Host "Database build skipped. Add build switch to run build." -ForegroundColor Black -BackgroundColor Red
    }
    ...
    Publish-SysAdminUser -SqlConnectionString $InstanceUnderUse
        ...
        Write-Host "Database deploy skipped. Add deploy switch to run build." -ForegroundColor Black -BackgroundColor Red
    }
}
